...
.method private fillList()V
    ...
    .line 213
    new-instance v24, Lcom/android/settings/profiles/NamePreference;
    ...
    invoke-direct/range {v24 .. v26}, Lcom/android/settings/profiles/NamePreference;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 224
    new-instance v24, Lcom/android/settings/profiles/ProfileConfig$RingModeItem;

    invoke-direct/range {v24 .. v24}, Lcom/android/settings/profiles/ProfileConfig$RingModeItem;-><init>()V
    ...
    .line 232
    new-instance v17, Lcom/android/settings/profiles/ProfileRingModePreference;
    ...
    .line 233
    .local v17, rmp:Lcom/android/settings/profiles/ProfileRingModePreference;
    move-object/from16 v0, p0
    ...
    .line 243
    new-instance v24, Lcom/android/settings/profiles/ProfileConfig$AirplaneModeItem;

    invoke-direct/range {v24 .. v24}, Lcom/android/settings/profiles/ProfileConfig$AirplaneModeItem;-><init>()V
    ...
    .end local v17           #rmp:Lcom/android/settings/profiles/ProfileRingModePreference;
    .end local v18           #rms:Landroid/app/RingModeSettings;
    :cond_6
    ...
    .line 300
    .local v20, stream:Lcom/android/settings/profiles/ProfileConfig$StreamItem;
    move-object/from16 v0, p0
    ...
    .line 306
    new-instance v14, Lcom/android/settings/profiles/StreamVolumePreference;
    ...
    invoke-direct {v14, v0}, Lcom/android/settings/profiles/StreamVolumePreference;-><init>(Landroid/content/Context;)V

    .line 307
    .local v14, pref:Lcom/android/settings/profiles/StreamVolumePreference;
    ...
    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/StreamVolumePreference;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/StreamVolumePreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/StreamVolumePreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/StreamVolumePreference;->setPersistent(Z)V

    .line 312
    move-object/from16 v0, v20

    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/StreamVolumePreference;->setStreamItem(Lcom/android/settings/profiles/ProfileConfig$StreamItem;)V

    .line 313
    move-object/from16 v0, v20

    iput-object v14, v0, Lcom/android/settings/profiles/ProfileConfig$StreamItem;->mCheckbox:Lcom/android/settings/profiles/StreamVolumePreference;
    ...
    .end local v12           #i$:I
    .end local v13           #len$:I
    .end local v14           #pref:Lcom/android/settings/profiles/StreamVolumePreference;
    .end local v19           #settings:Landroid/app/StreamSettings;
    .end local v20           #stream:Lcom/android/settings/profiles/ProfileConfig$StreamItem;
    :cond_8
    ...
    iget v0, v6, Lcom/android/settings/profiles/ProfileConfig$ConnectionItem;->mChoices:I
    ...
    .line 330
    new-instance v14, Lcom/android/settings/profiles/ProfileConnectionPreference;
    ...
    invoke-direct {v14, v0}, Lcom/android/settings/profiles/ProfileConnectionPreference;-><init>(Landroid/content/Context;)V

    .line 331
    .local v14, pref:Lcom/android/settings/profiles/ProfileConnectionPreference;
    new-instance v24, Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/ProfileConnectionPreference;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/ProfileConnectionPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/ProfileConnectionPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/settings/profiles/ProfileConnectionPreference;->setPersistent(Z)V

    .line 335
    invoke-virtual {v14, v6}, Lcom/android/settings/profiles/ProfileConnectionPreference;->setConnectionItem(Lcom/android/settings/profiles/ProfileConfig$ConnectionItem;)V

    .line 336
    iput-object v14, v6, Lcom/android/settings/profiles/ProfileConfig$ConnectionItem;->mCheckbox:Lcom/android/settings/profiles/ProfileConnectionPreference;
    ...
    .end local v14           #pref:Lcom/android/settings/profiles/ProfileConnectionPreference;
    .end local v19           #settings:Landroid/app/ConnectionSettings;
    :cond_a
