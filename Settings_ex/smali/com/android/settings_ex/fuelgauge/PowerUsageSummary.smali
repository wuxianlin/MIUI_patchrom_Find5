...
.field private mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;
...
.method static synthetic access$100(Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;)Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;
    .locals 1
    .parameter "x0"

    .prologue
    .line 50
    iget-object v0, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;

    return-object v0
.end method

.method static synthetic access$200(Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;)V
    .locals 0
    .parameter "x0"
...
.method private refreshStats()V
    ...
    .prologue
    .line 219
    iget-object v9, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mAppListGroup:Landroid/preference/PreferenceGroup;
    ...
    iget-object v10, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mBatteryStatusPref:Landroid/preference/Preference;
    ...
    iget-object v10, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;

    invoke-virtual {v10}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->getStats()Lcom/android/internal/os/BatteryStatsImpl;

    move-result-object v10

    iget-object v11, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;

    invoke-virtual {p0}, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->getActivity()Landroid/app/Activity;

    move-result-object v12

    invoke-virtual {v11, v12}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->getDockStats(Landroid/content/Context;)Lcom/android/internal/os/BatteryStatsImpl;

    move-result-object v11

    invoke-direct {v0, v9, v10, v11}, Lcom/android/settings_ex/fuelgauge/BatteryHistoryPreference;-><init>(Landroid/content/Context;Landroid/os/BatteryStats;Landroid/os/BatteryStats;)V

    .line 226
    .local v0, hist:Lcom/android/settings_ex/fuelgauge/BatteryHistoryPreference;
    const/4 v9, -0x1

    invoke-virtual {v0, v9}, Lcom/android/settings_ex/fuelgauge/BatteryHistoryPreference;->setOrder(I)V
    ...
    .line 229
    iget-object v9, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;

    invoke-virtual {v9}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->getPowerProfile()Lcom/android/internal/os/PowerProfile;
    ...
    invoke-virtual {v9, v10, v11}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->refreshStats(Landroid/content/Context;Z)V

    .line 235
    iget-object v9, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;

    invoke-virtual {v9}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->getUsageList()Ljava/util/List;

    move-result-object v8

    .line 236
    .local v8, usageList:Ljava/util/List;,"Ljava/util/List<Lcom/android/settings_ex/fuelgauge/BatterySipper;>;"
    ...
    invoke-virtual {v11}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->getTotalPower()D
    ...
    invoke-direct {v6, v9, v10, v7}, Lcom/android/settings_ex/fuelgauge/PowerGaugePreference;-><init>(Landroid/content/Context;Landroid/graphics/drawable/Drawable;Lcom/android/settings_ex/fuelgauge/BatterySipper;)V
    ...
    invoke-virtual {v11}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->getMaxPower()D
    ...
    .line 246
    iget-object v9, v7, Lcom/android/settings_ex/fuelgauge/BatterySipper;->name:Ljava/lang/String;

    invoke-virtual {v6, v9}, Lcom/android/settings_ex/fuelgauge/PowerGaugePreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v6, v9}, Lcom/android/settings_ex/fuelgauge/PowerGaugePreference;->setOrder(I)V

    .line 248
    invoke-virtual {v6, v2, v3, v4, v5}, Lcom/android/settings_ex/fuelgauge/PowerGaugePreference;->setPercent(DD)V

    .line 249
    iget-object v9, v7, Lcom/android/settings_ex/fuelgauge/BatterySipper;->uidObj:Landroid/os/BatteryStats$Uid;
    ...
    invoke-virtual {v6, v9}, Lcom/android/settings_ex/fuelgauge/PowerGaugePreference;->setKey(Ljava/lang/String;)V
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    .line 96
    new-instance v0, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;

    iget-object v1, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mHandler:Landroid/os/Handler;

    invoke-direct {v0, p1, v1}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;-><init>(Landroid/app/Activity;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->create(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mBatteryService:Landroid/os/BatteryManager;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    invoke-static {v4, v0, v1}, Lcom/android/settings_ex/HelpUtils;->prepareHelpMenuItem(Landroid/content/Context;Landroid/view/MenuItem;Ljava/lang/String;)Z
...
.method public onDestroy()V
    ...
    invoke-virtual {v0}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->destroy()V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 199
    :pswitch_1
    iget-object v1, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;

    invoke-virtual {v1}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->clearStats()V
    ...
    invoke-virtual {v1}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->resetStatistics()V
...
.method public onPause()V
    ...
    invoke-virtual {v0}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->pause()V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual {v1}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->getStats()Lcom/android/internal/os/BatteryStatsImpl;
    ...
    .line 141
    iget-object v0, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mBatteryService:Landroid/os/BatteryManager;
    ...
    invoke-virtual {v1, v3}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->getDockStats(Landroid/content/Context;)Lcom/android/internal/os/BatteryStatsImpl;
    ...
    .line 158
    iget-object v2, p0, Lcom/android/settings_ex/fuelgauge/PowerUsageSummary;->mStatsHelper:Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;
    ...
    invoke-virtual {v2, v0, v1, v3}, Lcom/android/settings_ex/fuelgauge/BatteryStatsHelper;->startBatteryDetailPage(Landroid/preference/PreferenceActivity;Lcom/android/settings_ex/fuelgauge/BatterySipper;Z)V
