...
.method static synthetic access$2800(Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;IILandroid/widget/NumberPicker;Landroid/widget/NumberPicker;Landroid/view/View;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 1801
    invoke-direct/range {p0 .. p5}, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;->updatePicker(IILandroid/widget/NumberPicker;Landroid/widget/NumberPicker;Landroid/view/View;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .prologue
    .line 1835
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v19

    .line 1836
    .local v19, context:Landroid/content/Context;
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;->getTargetFragment()Landroid/app/Fragment;

    move-result-object v17

    check-cast v17, Lcom/android/settings_ex/DataUsageSummary;

    .line 1837
    .local v17, target:Lcom/android/settings_ex/DataUsageSummary;
    #getter for: Lcom/android/settings_ex/DataUsageSummary;->mPolicyEditor:Lcom/android/settings_ex/net/NetworkPolicyEditor;
    invoke-static/range {v17 .. v17}, Lcom/android/settings_ex/DataUsageSummary;->access$2700(Lcom/android/settings_ex/DataUsageSummary;)Lcom/android/settings_ex/net/NetworkPolicyEditor;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    invoke-virtual {v5, v6}, Lcom/android/settings_ex/net/NetworkPolicyEditor;->getPolicyCycleLength(Landroid/net/NetworkTemplate;)I

    move-result v4

    .line 1844
    .local v4, cycleLength:I
    invoke-virtual {v5, v6}, Lcom/android/settings_ex/net/NetworkPolicyEditor;->getPolicyCycleDay(Landroid/net/NetworkTemplate;)I
    ...
    .line 1858
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;->getResources()Landroid/content/res/Resources;
    ...
    .line 1871
    new-instance v2, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment$1;

    move-object/from16 v3, p0

    invoke-direct/range {v2 .. v10}, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment$1;-><init>(Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;ILcom/android/settings_ex/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;ILandroid/widget/NumberPicker;Landroid/widget/NumberPicker;Landroid/view/View;)V
    ...
    .line 1892
    invoke-direct/range {v11 .. v16}, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;->updatePicker(IILandroid/widget/NumberPicker;Landroid/widget/NumberPicker;Landroid/view/View;)V
    ...
    new-instance v11, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment$2;
    ...
    invoke-direct/range {v11 .. v17}, Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment$2;-><init>(Lcom/android/settings_ex/DataUsageSummary$CycleEditorFragment;Landroid/widget/NumberPicker;Landroid/widget/NumberPicker;Lcom/android/settings_ex/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/settings_ex/DataUsageSummary;)V
