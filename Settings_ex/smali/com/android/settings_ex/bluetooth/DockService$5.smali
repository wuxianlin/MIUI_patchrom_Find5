...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    #getter for: Lcom/android/settings_ex/bluetooth/DockService;->mDevice:Landroid/bluetooth/BluetoothDevice;
    invoke-static {v2}, Lcom/android/settings_ex/bluetooth/DockService;->access$400(Lcom/android/settings_ex/bluetooth/DockService;)Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-static {v1, v2}, Lcom/android/settings_ex/bluetooth/LocalBluetoothPreferences;->hasDockAutoConnectSetting(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v1, v2, v0}, Lcom/android/settings_ex/bluetooth/LocalBluetoothPreferences;->saveDockAutoConnectSetting(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    #getter for: Lcom/android/settings_ex/bluetooth/DockService;->mAudioMediaCheckbox:Landroid/widget/CheckBox;
    invoke-static {v1}, Lcom/android/settings_ex/bluetooth/DockService;->access$800(Lcom/android/settings_ex/bluetooth/DockService;)Landroid/widget/CheckBox;
    ...
    invoke-virtual {v1}, Lcom/android/settings_ex/bluetooth/DockService;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    const-string v2, "dock_audio_media_enabled"

    iget-object v3, p0, Lcom/android/settings_ex/bluetooth/DockService$5;->this$0:Lcom/android/settings_ex/bluetooth/DockService;

    #getter for: Lcom/android/settings_ex/bluetooth/DockService;->mAudioMediaCheckbox:Landroid/widget/CheckBox;
    invoke-static {v3}, Lcom/android/settings_ex/bluetooth/DockService;->access$800(Lcom/android/settings_ex/bluetooth/DockService;)Landroid/widget/CheckBox;
