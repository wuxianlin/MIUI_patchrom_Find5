...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 582
    invoke-virtual {p0, v3, v6}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->startActivityForResultSafely(Landroid/content/Intent;I)V
    ...
    :cond_3
    invoke-virtual {p0, v6, v7, p3}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 588
    iget-object v5, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    :cond_6
    invoke-direct {p0, v8}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->finishDelayedAndShowLockScreen(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 93
    invoke-virtual {p0}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->setContentView(I)V
    ...
    invoke-virtual {p0, v5, v3}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->setResultData(ILandroid/content/Intent;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->findViewById(I)Landroid/view/View;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v7, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mItems:Ljava/util/List;
    ...
    iget-object v7, v3, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity$Item;->extras:Landroid/os/Bundle;
    ...
    .line 519
    .local v5, result:I
    invoke-virtual {p0, v5, v2}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->setResultData(ILandroid/content/Intent;)V

    .line 544
    :goto_0
    iget-boolean v7, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAddingToKeyguard:Z
    ...
    iget-object v8, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mResultData:Landroid/content/Intent;

    invoke-virtual {p0, v7, v5, v8}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->onActivityResult(IILandroid/content/Intent;)V
    ...
    iget v7, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetId:I
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->getString(I)Ljava/lang/String;
    ...
    iput v7, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetId:I
    ...
    :cond_1
    iget-object v7, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetManager:Landroid/appwidget/AppWidgetManager;

    iget v8, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mAppWidgetId:I

    invoke-virtual {v2}, Landroid/content/Intent;->getComponent()Landroid/content/ComponentName;

    move-result-object v9

    iget-object v10, p0, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->mExtraConfigureOptions:Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v5, v7}, Lcom/android/settings_ex/KeyguardAppWidgetPickActivity;->setResultData(ILandroid/content/Intent;)V
