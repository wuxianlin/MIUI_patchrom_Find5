...
.method static synthetic access$300(Lcom/android/settings_ex/SoundSettings;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$400(Lcom/android/settings_ex/SoundSettings;ILandroid/preference/Preference;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private launchNotificationSoundPicker(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings_ex/SoundSettings;->getString(I)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lcom/android/settings_ex/SoundSettings;->startActivityForResult(Landroid/content/Intent;I)V
...
.method private setPowerNotificationRingtone(Landroid/content/Intent;)V
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/settings_ex/SoundSettings;->mPowerSoundsRingtone:Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/SoundSettings;->getString(I)Ljava/lang/String;
...
.method private updateState(Z)V
    ...
    .line 355
    .local v0, resolver:Landroid/content/ContentResolver;
    iget-object v1, p0, Lcom/android/settings_ex/SoundSettings;->mRingMode:Landroid/preference/ListPreference;

    invoke-direct {p0}, Lcom/android/settings_ex/SoundSettings;->getPhoneRingModeSettingValue()Ljava/lang/String;
    ...
    .line 358
    iget-object v1, p0, Lcom/android/settings_ex/SoundSettings;->mQuietHours:Landroid/preference/PreferenceScreen;
    ...
    invoke-direct {p0, v3}, Lcom/android/settings_ex/SoundSettings;->returnTime(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings_ex/SoundSettings;->mRingMode:Landroid/preference/ListPreference;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/SoundSettings;->getString(I)Ljava/lang/String;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 619
    invoke-direct {p0, p3}, Lcom/android/settings_ex/SoundSettings;->setPowerNotificationRingtone(Landroid/content/Intent;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 165
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings_ex/SoundSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/SoundSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/SoundSettings;->addPreferencesFromResource(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/SoundSettings;->mVolumeOverlay:Landroid/preference/ListPreference;

    .line 178
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/SoundSettings;->mVolumeOverlay:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/SoundSettings;->mRingMode:Landroid/preference/ListPreference;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/SoundSettings;->mRingMode:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/SoundSettings;->mQuietHours:Landroid/preference/PreferenceScreen;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/SoundSettings;->mQuietHours:Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/SoundSettings;->getString(I)Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings_ex/SoundSettings;->returnTime(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/settings_ex/Utils;->hasVolumeRocker(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/SoundSettings;->removePreference(Ljava/lang/String;)V
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/settings_ex/Utils;->isVoiceCapable(Landroid/content/Context;)Z
    ...
    .line 247
    sget-object v3, Lcom/android/settings_ex/SoundSettings;->NEED_VOICE_CAPABILITY:[Ljava/lang/String;
    ...
    invoke-virtual {v0, v11}, Lcom/android/settings_ex/SoundSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    .end local v8           #len$:I
    :cond_c
    new-instance v17, Lcom/android/settings_ex/SoundSettings$3;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/SoundSettings;->mPowerSounds:Landroid/preference/CheckBoxPreference;

    .line 271
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/SoundSettings;->mPowerSounds:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/SoundSettings;->mPowerSoundsVibrate:Landroid/preference/CheckBoxPreference;

    .line 274
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/SoundSettings;->mPowerSoundsVibrate:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/SoundSettings;->mPowerSoundsRingtone:Landroid/preference/Preference;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/SoundSettings;->mPowerSoundsRingtone:Landroid/preference/Preference;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .restart local p2
    :cond_1
    iget-object v4, p0, Lcom/android/settings_ex/SoundSettings;->mRingMode:Landroid/preference/ListPreference;
    ...
    invoke-direct {p0, v4}, Lcom/android/settings_ex/SoundSettings;->setPhoneRingModeValue(Ljava/lang/String;)V

    goto :goto_0

    .line 476
    :cond_2
    iget-object v4, p0, Lcom/android/settings_ex/SoundSettings;->mVolumeOverlay:Landroid/preference/ListPreference;
    ...
    iget-object v5, p0, Lcom/android/settings_ex/SoundSettings;->mVolumeOverlay:Landroid/preference/ListPreference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 409
    :cond_2
    iget-object v0, p0, Lcom/android/settings_ex/SoundSettings;->mMusicFx:Landroid/preference/Preference;

    if-eq p2, v0, :cond_0

    .line 412
    iget-object v0, p0, Lcom/android/settings_ex/SoundSettings;->mDockAudioSettings:Landroid/preference/Preference;

    if-ne p2, v0, :cond_8

    .line 413
    iget-object v0, p0, Lcom/android/settings_ex/SoundSettings;->mDockIntent:Landroid/content/Intent;
    ...
    .line 418
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/SoundSettings;->showDialog(I)V
    ...
    iget-object v1, p0, Lcom/android/settings_ex/SoundSettings;->mDockIntent:Landroid/content/Intent;

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Landroid/content/Intent;)V

    .line 424
    const-string v1, "com.android.settings_ex.bluetooth.action.DOCK_SHOW_UI"
    ...
    .line 433
    invoke-super {p0, v0, v0}, Lcom/android/settings_ex/SettingsPreferenceFragment;->onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z

    goto :goto_0

    .line 436
    :cond_8
    iget-object v0, p0, Lcom/android/settings_ex/SoundSettings;->mDockSounds:Landroid/preference/CheckBoxPreference;
    ...
    .line 439
    :cond_a
    iget-object v0, p0, Lcom/android/settings_ex/SoundSettings;->mDockAudioMediaEnabled:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v4, p0, Lcom/android/settings_ex/SoundSettings;->mDockAudioMediaEnabled:Landroid/preference/CheckBoxPreference;
    ...
    .line 442
    :cond_c
    iget-object v0, p0, Lcom/android/settings_ex/SoundSettings;->mPowerSounds:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v4, p0, Lcom/android/settings_ex/SoundSettings;->mPowerSounds:Landroid/preference/CheckBoxPreference;
    ...
    .line 447
    :cond_e
    iget-object v0, p0, Lcom/android/settings_ex/SoundSettings;->mPowerSoundsVibrate:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v4, p0, Lcom/android/settings_ex/SoundSettings;->mPowerSoundsVibrate:Landroid/preference/CheckBoxPreference;
    ...
    .line 452
    :cond_10
    iget-object v0, p0, Lcom/android/settings_ex/SoundSettings;->mPowerSoundsRingtone:Landroid/preference/Preference;
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/settings_ex/SoundSettings;->launchNotificationSoundPicker(ILjava/lang/String;)V
...
.method public onResume()V
    ...
    invoke-direct {p0, v1}, Lcom/android/settings_ex/SoundSettings;->updateState(Z)V
