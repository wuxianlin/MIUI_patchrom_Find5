...
.field private mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/WirelessSettings;->VOICE_PLUS_SETUP:Landroid/content/ComponentName;
...
.method private initSmsApplicationSetting()V
    ...
    invoke-virtual {p0}, Lcom/android/settings_ex/WirelessSettings;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    :cond_0
    iget-object v10, p0, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;

    invoke-virtual {v10, v2}, Lcom/android/settings_ex/SmsListPreference;->setEntries([Ljava/lang/CharSequence;)V

    .line 221
    iget-object v10, p0, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;

    invoke-virtual {v10, v4}, Lcom/android/settings_ex/SmsListPreference;->setEntryValues([Ljava/lang/CharSequence;)V

    .line 222
    iget-object v10, p0, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;

    invoke-virtual {v10, v3}, Lcom/android/settings_ex/SmsListPreference;->setEntryDrawables([Landroid/graphics/drawable/Drawable;)V

    .line 223
    invoke-direct {p0}, Lcom/android/settings_ex/WirelessSettings;->updateSmsApplicationSetting()V
...
.method private updateSmsApplicationSetting()V
    ...
    iget-object v4, p0, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;

    invoke-virtual {v4}, Lcom/android/settings_ex/SmsListPreference;->getEntryValues()[Ljava/lang/CharSequence;
    ...
    invoke-virtual {v4, v1}, Lcom/android/settings_ex/SmsListPreference;->setValueIndex(I)V

    .line 190
    iget-object v4, p0, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;

    iget-object v5, p0, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;

    invoke-virtual {v5}, Lcom/android/settings_ex/SmsListPreference;->getEntries()[Ljava/lang/CharSequence;

    move-result-object v5

    aget-object v5, v5, v1

    invoke-virtual {v4, v5}, Lcom/android/settings_ex/SmsListPreference;->setSummary(Ljava/lang/CharSequence;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, v2, v14, v3}, Lcom/android/settings_ex/nfc/NfcEnabler;-><init>(Landroid/content/Context;Landroid/preference/CheckBoxPreference;Landroid/preference/PreferenceScreen;)V
    ...
    check-cast v22, Lcom/android/settings_ex/SmsListPreference;

    move-object/from16 v0, v22

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;

    .line 308
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/SmsListPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings_ex/WirelessSettings;->protectByRestrictions(Ljava/lang/String;)V
    ...
    invoke-static/range {v22 .. v23}, Lcom/android/settings_ex/Utils;->isPackageInstalled(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public onManageMobilePlanClick()V
    ...
    invoke-direct {p0, v6}, Lcom/android/settings_ex/WirelessSettings;->log(Ljava/lang/String;)V

    .line 135
    iput-object v10, p0, Lcom/android/settings_ex/WirelessSettings;->mManageMobilePlanMessage:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/settings_ex/WirelessSettings;->mCm:Landroid/net/ConnectivityManager;
    ...
    iget-object v6, p0, Lcom/android/settings_ex/WirelessSettings;->mTm:Landroid/telephony/TelephonyManager;
    ...
    :goto_0
    iget-object v6, p0, Lcom/android/settings_ex/WirelessSettings;->mManageMobilePlanMessage:Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/android/settings_ex/WirelessSettings;->mManageMobilePlanMessage:Ljava/lang/String;
    ...
    .line 176
    invoke-virtual {p0, v8}, Lcom/android/settings_ex/WirelessSettings;->showDialog(I)V
    ...
    iput-object v6, p0, Lcom/android/settings_ex/WirelessSettings;->mManageMobilePlanMessage:Ljava/lang/String;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .prologue
    .line 499
    iget-object v0, p0, Lcom/android/settings_ex/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings_ex/SmsListPreference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 107
    invoke-virtual {p0, p2}, Lcom/android/settings_ex/WirelessSettings;->ensurePinRestrictedPreference(Landroid/preference/Preference;)Z
    ...
    .line 111
    iget-object v2, p0, Lcom/android/settings_ex/WirelessSettings;->mAirplaneModePreference:Landroid/preference/CheckBoxPreference;
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/settings_ex/WirelessSettings;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    sget-object v1, Lcom/android/settings_ex/WirelessSettings;->VOICE_PLUS_SETUP:Landroid/content/ComponentName;
    ...
    .line 124
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/WirelessSettings;->startActivity(Landroid/content/Intent;)V
