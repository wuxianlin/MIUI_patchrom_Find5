...
.method constructor <init>(Lcom/android/settings_ex/applications/ManageApplications;Landroid/content/pm/PackageManager;Landroid/app/INotificationManager;Landroid/content/pm/IPackageManager;Landroid/app/AppOpsManager;Landroid/net/NetworkPolicyManager;Landroid/os/Handler;)V
    ...
    iput-object p2, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$pm:Landroid/content/pm/PackageManager;

    iput-object p3, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$nm:Landroid/app/INotificationManager;

    iput-object p4, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$mIPm:Landroid/content/pm/IPackageManager;

    iput-object p5, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$aom:Landroid/app/AppOpsManager;

    iput-object p6, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$npm:Landroid/net/NetworkPolicyManager;

    iput-object p7, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$handler:Landroid/os/Handler;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local p1
    invoke-virtual {p0, p1}, Lcom/android/settings_ex/applications/ManageApplications$1;->doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
    ...
    .prologue
    .line 1133
    iget-object v9, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$pm:Landroid/content/pm/PackageManager;
    ...
    :try_start_0
    iget-object v9, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$nm:Landroid/app/INotificationManager;
    ...
    :cond_1
    :try_start_1
    iget-object v9, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$mIPm:Landroid/content/pm/IPackageManager;
    ...
    .line 1156
    :goto_2
    iget-object v9, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$aom:Landroid/app/AppOpsManager;

    invoke-virtual {v9}, Landroid/app/AppOpsManager;->resetAllModes()V

    .line 1157
    iget-object v9, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$npm:Landroid/net/NetworkPolicyManager;
    ...
    .end local v8           #uid:I
    :cond_3
    iget-object v9, p0, Lcom/android/settings_ex/applications/ManageApplications$1;->val$handler:Landroid/os/Handler;

    new-instance v10, Lcom/android/settings_ex/applications/ManageApplications$1$1;

    invoke-direct {v10, p0}, Lcom/android/settings_ex/applications/ManageApplications$1$1;-><init>(Lcom/android/settings_ex/applications/ManageApplications$1;)V
