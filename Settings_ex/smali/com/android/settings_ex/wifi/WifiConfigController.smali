...
# direct methods
.method public constructor <init>(Lcom/android/settings_ex/wifi/WifiConfigUiBase;Landroid/view/View;Lcom/android/settings_ex/wifi/AccessPoint;ZZLjava/util/List;)V
    .locals 23
    .parameter "parent"
    .parameter "view"
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/android/settings_ex/wifi/WifiConfigUiBase;",
            "Landroid/view/View;",
    ...
    iput-boolean v0, v1, Lcom/android/settings_ex/wifi/WifiConfigController;->mIbssSupported:Z
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiConfigController;->mIbssView:Landroid/widget/CheckBox;

    .line 183
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mIbssView:Landroid/widget/CheckBox;
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiConfigController;->mIbssFreqSpinner:Landroid/widget/Spinner;
    ...
    iget-boolean v0, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mIbssSupported:Z
    ...
    iput-object v0, v1, Lcom/android/settings_ex/wifi/WifiConfigController;->mSupportedIbssChannels:Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mSupportedIbssChannels:Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/android/settings_ex/wifi/WifiConfigController;->mIbssFreqSpinner:Landroid/widget/Spinner;
    ...
    invoke-direct {v0, v10, v1, v2}, Lcom/android/settings_ex/wifi/WifiConfigController;->addRow(Landroid/view/ViewGroup;ILjava/lang/String;)V
    ...
    iget v0, v0, Lcom/android/settings_ex/wifi/AccessPoint;->frequency:I
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/settings_ex/wifi/AccessPoint;->getState()Landroid/net/NetworkInfo$DetailedState;
    ...
    invoke-interface/range {v20 .. v20}, Lcom/android/settings_ex/wifi/WifiConfigUiBase;->getContext()Landroid/content/Context;
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/settings_ex/wifi/AccessPoint;->getLevel()I
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/settings_ex/wifi/AccessPoint;->getInfo()Landroid/net/wifi/WifiInfo;
    ...
    invoke-virtual/range {v20 .. v21}, Lcom/android/settings_ex/wifi/AccessPoint;->getSecurityString(Z)Ljava/lang/String;
    ...
    iget-boolean v15, v0, Lcom/android/settings_ex/wifi/AccessPoint;->isIBSS:Z
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/settings_ex/wifi/AccessPoint;->getConfig()Landroid/net/wifi/WifiConfiguration;
...
.method private showEapFieldsByMethod(I)V
    ...
    .line 740
    :pswitch_2
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mPhase2Adapter:Landroid/widget/ArrayAdapter;

    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->PHASE2_PEAP_ADAPTER:Landroid/widget/ArrayAdapter;

    if-eq v0, v1, :cond_0

    .line 741
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->PHASE2_PEAP_ADAPTER:Landroid/widget/ArrayAdapter;

    iput-object v0, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mPhase2Adapter:Landroid/widget/ArrayAdapter;

    .line 742
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mPhase2Spinner:Landroid/widget/Spinner;

    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mPhase2Adapter:Landroid/widget/ArrayAdapter;
    ...
    iget-object v1, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->PHASE2_FULL_ADAPTER:Landroid/widget/ArrayAdapter;

    if-eq v0, v1, :cond_1

    .line 751
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->PHASE2_FULL_ADAPTER:Landroid/widget/ArrayAdapter;
...
.method private showSecurityFields()V
    ...
    .line 654
    iget-object v3, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mEapMethodSpinner:Landroid/widget/Spinner;
...
.method getConfig()Landroid/net/wifi/WifiConfiguration;
    ...
    .line 377
    iget-object v7, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mIbssView:Landroid/widget/CheckBox;
    ...
    .line 379
    iget-object v7, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mSupportedIbssChannels:Ljava/util/List;

    iget v8, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mSelectedIbssChannelPos:I
    ...
    iget-boolean v7, v7, Lcom/android/settings_ex/wifi/AccessPoint;->isIBSS:Z
    ...
    iget v7, v7, Lcom/android/settings_ex/wifi/AccessPoint;->frequency:I
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 967
    :cond_2
    iget-object v0, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mIbssFreqSpinner:Landroid/widget/Spinner;

    if-ne p1, v0, :cond_3

    .line 968
    iput p3, p0, Lcom/android/settings_ex/wifi/WifiConfigController;->mSelectedIbssChannelPos:I
