...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/deviceinfo/Memory;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/hardware/usb/UsbManager;

    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    iput-object v6, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageManager:Landroid/os/storage/StorageManager;

    .line 93
    iget-object v6, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageManager:Landroid/os/storage/StorageManager;

    iget-object v7, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageListener:Landroid/os/storage/StorageEventListener;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/deviceinfo/Memory;->addPreferencesFromResource(I)V
    ...
    invoke-direct {p0, v6}, Lcom/android/settings_ex/deviceinfo/Memory;->addCategory(Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;)V
    ...
    .line 102
    invoke-static {v1, v5}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->buildForPhysical(Landroid/content/Context;Landroid/os/storage/StorageVolume;)Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings_ex/deviceinfo/Memory;->setHasOptionsMenu(Z)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    new-instance v2, Lcom/android/settings_ex/deviceinfo/Memory$3;

    invoke-direct {v2, p0}, Lcom/android/settings_ex/deviceinfo/Memory$3;-><init>(Lcom/android/settings_ex/deviceinfo/Memory;)V
