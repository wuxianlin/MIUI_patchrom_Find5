...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings$1;-><init>(Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;)V

    iput-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mOnImePreferenceChangedListener:Landroid/preference/Preference$OnPreferenceChangeListener;
...
.method static synthetic access$100(Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$200(Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;)V
    .locals 0
    .parameter "x0"
...
.method private getInputMethodPreference(Landroid/view/inputmethod/InputMethodInfo;)Lcom/android/settings_ex/inputmethod/InputMethodPreference;
    .locals 6
    .parameter "imi"
    ...
    .line 515
    :goto_0
    new-instance v3, Lcom/android/settings_ex/inputmethod/InputMethodPreference;
    ...
    invoke-direct {v3, p0, v0, v5, p1}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;-><init>(Lcom/android/settings_ex/SettingsPreferenceFragment;Landroid/content/Intent;Landroid/view/inputmethod/InputMethodManager;Landroid/view/inputmethod/InputMethodInfo;)V

    .line 517
    .local v3, pref:Lcom/android/settings_ex/inputmethod/InputMethodPreference;
    invoke-virtual {p1}, Landroid/view/inputmethod/InputMethodInfo;->getId()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v3, v5}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->setKey(Ljava/lang/String;)V

    .line 518
    invoke-virtual {v3, v1}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .end local v3           #pref:Lcom/android/settings_ex/inputmethod/InputMethodPreference;
    :cond_0
    const/4 v0, 0x0
...
.method private updateHardKeyboards()V
    ...
    invoke-direct {v10, p0, v5}, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings$3;-><init>(Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;Ljava/lang/String;)V
...
.method private updateInputMethodPreferenceViews()V
    ...
    check-cast v5, Lcom/android/settings_ex/inputmethod/InputMethodPreference;

    .line 450
    .local v5, imp:Lcom/android/settings_ex/inputmethod/InputMethodPreference;
    ...
    .end local v5           #imp:Lcom/android/settings_ex/inputmethod/InputMethodPreference;
    :catchall_0
    move-exception v7
    ...
    invoke-virtual {v7}, Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;->getInputMethodList()Ljava/util/List;
    ...
    invoke-direct {p0, v3}, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->getInputMethodPreference(Landroid/view/inputmethod/InputMethodInfo;)Lcom/android/settings_ex/inputmethod/InputMethodPreference;

    move-result-object v6

    .line 458
    .local v6, pref:Lcom/android/settings_ex/inputmethod/InputMethodPreference;
    iget-object v7, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mOnImePreferenceChangedListener:Landroid/preference/Preference$OnPreferenceChangeListener;

    invoke-virtual {v6, v7}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->setOnImePreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    check-cast v6, Lcom/android/settings_ex/inputmethod/InputMethodPreference;

    .line 471
    .local v6, pref:Landroid/preference/Preference;
    instance-of v7, v6, Lcom/android/settings_ex/inputmethod/InputMethodPreference;
    ...
    invoke-virtual {v6}, Lcom/android/settings_ex/inputmethod/InputMethodPreference;->updatePreferenceViews()V
    ...
    iget-object v8, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mInputMethodSettingValues:Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;

    invoke-virtual {v8}, Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;->getInputMethodList()Ljava/util/List;

    move-result-object v8

    const/4 v9, 0x0

    invoke-static {p0, v7, v8, v9}, Lcom/android/settings_ex/inputmethod/InputMethodAndSubtypeUtil;->loadInputMethodSubtypeList(Lcom/android/settings_ex/SettingsPreferenceFragment;Landroid/content/ContentResolver;Ljava/util/List;Ljava/util/Map;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->addPreferencesFromResource(I)V

    .line 123
    const v0, 0x7f080412

    :try_start_0
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->getString(I)Ljava/lang/String;
    ...
    .line 142
    :goto_1
    new-instance v0, Lcom/android/settings_ex/VoiceInputOutputSettings;

    invoke-direct {v0, p0}, Lcom/android/settings_ex/VoiceInputOutputSettings;-><init>(Lcom/android/settings_ex/SettingsPreferenceFragment;)V

    invoke-virtual {v0}, Lcom/android/settings_ex/VoiceInputOutputSettings;->onCreate()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mHardKeyboardCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mKeyboardSettingsCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mGameControllerCategory:Landroid/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mHardKeyboardCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mInputMethodSettingValues:Lcom/android/settings_ex/inputmethod/InputMethodSettingValuesWrapper;

    .line 168
    iget-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mKeyboardSettingsCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mIm:Landroid/hardware/input/InputManager;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mStylusGestures:Landroid/preference/PreferenceScreen;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mStylusIconEnabled:Landroid/preference/CheckBoxPreference;
    ...
    .line 188
    iget-object v1, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mStylusGestures:Landroid/preference/PreferenceScreen;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    .line 189
    iget-object v1, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mStylusIconEnabled:Landroid/preference/CheckBoxPreference;
    ...
    invoke-static {v1, v0, v2}, Lcom/android/settings_ex/Utils;->updatePreferenceToSpecificActivityFromMetaDataOrRemove(Landroid/content/Context;Landroid/preference/PreferenceGroup;Ljava/lang/String;)Z
    ...
    iput-object v0, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mLanguagePref:Landroid/preference/Preference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 373
    :cond_0
    iget-object v5, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mStylusIconEnabled:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v7, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mStylusIconEnabled:Landroid/preference/CheckBoxPreference;
...
.method public onResume()V
    ...
    .line 313
    :cond_1
    iget-object v6, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mStylusIconEnabled:Landroid/preference/CheckBoxPreference;

    if-eqz v6, :cond_2

    .line 314
    iget-object v9, p0, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->mStylusIconEnabled:Landroid/preference/CheckBoxPreference;
    ...
    invoke-direct {p0, v4, v6}, Lcom/android/settings_ex/inputmethod/InputMethodAndLanguageSettings;->hasOnlyOneLanguageInstance(Ljava/lang/String;[Ljava/lang/String;)Z
