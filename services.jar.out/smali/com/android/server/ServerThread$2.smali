...
.method public run()V
    ...
    .line 1262
    .local v0, customTheme:Landroid/content/res/CustomTheme;
    invoke-virtual {v0}, Landroid/content/res/CustomTheme;->getIconPackPkgName()Ljava/lang/String;
    ...
    invoke-interface {v3, v2}, Landroid/content/pm/IPackageManager;->updateIconMapping(Ljava/lang/String;)V
    :try_end_1c
    .catch Ljava/lang/Throwable; {:try_start_1c .. :try_end_1c} :catch_1c

    .line 1268
    .end local v0           #customTheme:Landroid/content/res/CustomTheme;
    ...
    invoke-virtual {v3, v4, v1}, Lcom/android/server/ServerThread;->reportWtf(Ljava/lang/String;Ljava/lang/Throwable;)V
