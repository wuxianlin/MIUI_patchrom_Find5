...
.method public run()V
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->access$500(Lcom/android/server/connectivity/Tethering;)I
    ...
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering$DoScan;->access$600(Lcom/android/server/connectivity/Tethering$DoScan;)I
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->access$700(Lcom/android/server/connectivity/Tethering;)Landroid/app/Notification;
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->access$400(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    ...
    #getter for: Lcom/android/server/connectivity/Tethering$DoScan;->mCurrentClientCount:I
    invoke-static {v10}, Lcom/android/server/connectivity/Tethering$DoScan;->access$600(Lcom/android/server/connectivity/Tethering$DoScan;)I
    ...
    #calls: Lcom/android/server/connectivity/Tethering;->getUiContext()Landroid/content/Context;
    invoke-static {v1}, Lcom/android/server/connectivity/Tethering;->access$800(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->access$900(Lcom/android/server/connectivity/Tethering;)Landroid/app/NotificationManager;
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mTetheredNotification:Landroid/app/Notification;
    invoke-static {v1}, Lcom/android/server/connectivity/Tethering;->access$700(Lcom/android/server/connectivity/Tethering;)Landroid/app/Notification;
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mTetheredNotification:Landroid/app/Notification;
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering;->access$700(Lcom/android/server/connectivity/Tethering;)Landroid/app/Notification;
