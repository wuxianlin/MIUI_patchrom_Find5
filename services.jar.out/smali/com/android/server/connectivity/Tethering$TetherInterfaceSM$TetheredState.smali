...
.method private cleanupUpstream()V
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->access$3300(Lcom/android/server/connectivity/Tethering;)Landroid/net/INetworkStatsService;
    ...
    sget-object v2, Lcom/android/server/connectivity/Tethering$IPAddrType;->V4:Lcom/android/server/connectivity/Tethering$IPAddrType;

    sget-object v3, Lcom/android/server/connectivity/Tethering$UpstreamInfoUpdateType;->UPSTREAM_IFACE_REMOVED:Lcom/android/server/connectivity/Tethering$UpstreamInfoUpdateType;

    #calls: Lcom/android/server/connectivity/Tethering;->sendUpstreamIfaceChangeBroadcast(Ljava/lang/String;Lcom/android/server/connectivity/Tethering$IPAddrType;Lcom/android/server/connectivity/Tethering$UpstreamInfoUpdateType;)V
    invoke-static {v0, v1, v2, v3}, Lcom/android/server/connectivity/Tethering;->access$3400(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;Lcom/android/server/connectivity/Tethering$IPAddrType;Lcom/android/server/connectivity/Tethering$UpstreamInfoUpdateType;)V
    :try_end_1
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/Tethering;->access$1500(Lcom/android/server/connectivity/Tethering;)Lcom/android/internal/util/StateMachine;
    ...
    invoke-static {v4, v7}, Lcom/android/server/connectivity/Tethering;->access$1600(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastError(I)V
    invoke-static {v4, v9}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$2000(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    sget-object v5, Lcom/android/server/connectivity/Tethering$IPAddrType;->V4:Lcom/android/server/connectivity/Tethering$IPAddrType;

    sget-object v6, Lcom/android/server/connectivity/Tethering$UpstreamInfoUpdateType;->UPSTREAM_IFACE_ADDED:Lcom/android/server/connectivity/Tethering$UpstreamInfoUpdateType;

    #calls: Lcom/android/server/connectivity/Tethering;->sendUpstreamIfaceChangeBroadcast(Ljava/lang/String;Lcom/android/server/connectivity/Tethering$IPAddrType;Lcom/android/server/connectivity/Tethering$UpstreamInfoUpdateType;)V
    invoke-static {v4, v2, v5, v6}, Lcom/android/server/connectivity/Tethering;->access$3400(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;Lcom/android/server/connectivity/Tethering$IPAddrType;Lcom/android/server/connectivity/Tethering$UpstreamInfoUpdateType;)V
    :try_end_1
    ...
    #calls: Lcom/android/server/connectivity/Tethering;->sendTetherStateChangedBroadcast()V
    invoke-static {v4}, Lcom/android/server/connectivity/Tethering;->access$1900(Lcom/android/server/connectivity/Tethering;)V
